    ...
    return (
        <div className="mt-12">
            <div className="flex flex-wrap lg:flex-nowrap justify-center">
                <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 welcome-bg bg-no-repeat bg-cover bg-center">
                ...
                <div className="w-400 bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl p-6 m-3">
                    ...
                    <div className="mt-10">
                        ...
                        <div className="mt-8">
                            ...
                            <p className="text-gray-400 ">By Dashify</p>
                            <p className="mt-5 text-sm text-gray-400">
                                Check out and keep track of daily activities to
                                track and organize tasks effectively.
                            </p>
                            <div className="mt-3">
                                <Button
                                    color="white"
